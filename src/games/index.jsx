...
export const gameRoutes = {
  ...
  'greedy-cat': {
    ...
    instructions: (
      <>
        <p>1. 先選擇難度：🐢 簡單、🐱 中等、🔥 困難，速度、家具障礙與道具種類都不同。</p>
        <p>2. 操控貪吃的金吉拉毛毛蟲，吃到魚乾 🐟 就會變長、分數 +1。</p>
        <p>3. 撞到牆壁、自己的身體或 🪴 家具障礙（中等/困難模式才有）就遊戲結束！</p>
        <p>4. 每吃 5 條魚乾會出現限時的金色魚乾，吃到 +5 分並長更多，但要手腳快，太晚吃會消失。</p>
        <p>5. 偶爾會出現道具：🌿 貓草無敵（短暫不怕撞到自己或障礙）、🧲 魚乾磁鐵（吸引附近的魚乾）、🐌 減速藥水（暫時放慢速度），效果與出現機率依模式而不同。</p>
        <p>6. 身體越長、分數越高，速度就會越快！電腦用方向鍵，手機拖曳畫面下方的搖桿。各難度的最高分分開計算。</p>
      </>
    ),
  },
  'hide-and-seek': {
